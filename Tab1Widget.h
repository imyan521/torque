#ifndef TAB1WIDGET_H
#define TAB1WIDGET_H
// #define TILT_ZERO 205.291f
// #define TORQUE_ZERO 0.019f
...
public:
    explicit Tab1Widget(Ui::MainWindow *ui, QWidget *parent = nullptr);
    ~Tab1Widget();
...
public slots:
    //void onDataReceived(const QByteArray& data); // 定义槽函数
