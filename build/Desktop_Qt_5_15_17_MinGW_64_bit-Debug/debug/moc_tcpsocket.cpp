...
QT_MOC_LITERAL(1, 9, 15), // "bool_data_reciv"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 17), // "clientListUpdated"
QT_MOC_LITERAL(4, 44, 10), // "clientList"
QT_MOC_LITERAL(5, 55, 15), // "onNewConnection"
QT_MOC_LITERAL(6, 71, 14), // "readClientData"
QT_MOC_LITERAL(7, 86, 20) // "onClientDisconnected"

    },
    "MyServer\0bool_data_reciv\0\0clientListUpdated\0"
    "clientList\0onNewConnection\0readClientData\0"
...
void MyServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->bool_data_reciv(); break;
        case 1: _t->clientListUpdated((*reinterpret_cast< const QStringList(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyServer::bool_data_reciv)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MyServer::*)(const QStringList & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyServer::clientListUpdated)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MyServer::bool_data_reciv()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void MyServer::clientListUpdated(const QStringList & _t1)
{
